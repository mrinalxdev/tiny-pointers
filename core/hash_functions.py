...
class HashFunction:
    ...
    def __init__(self, m : int, seed : int | None = None):
        ...
        self._a = rng.randrange(1, _MOD) | 1
...
class HashFamily:
    __slots__ = ("_master_seed", "_cache", "_m")
    def __init__(self, m : int, master_seed: int | None = None):
        self._m = m
        self.master_seed = master_seed if master_seed is not None else random.randrange(0, _MOD)
